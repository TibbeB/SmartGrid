...
def hillclimber(smartgrid: Smartgrid, valid_state: dict[object, list[object]],
    battery: dict[int, object], cable_connection_algorithm: Callable[dict[object, list[object]],
    dict[int, object]],
    cable_connection_algorithm_name: str, max_time: int) -> tuple[dict[object, list[object]], list[int], int, int]:    
